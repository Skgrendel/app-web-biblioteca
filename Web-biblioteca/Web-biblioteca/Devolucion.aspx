<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Devolucion.aspx.cs" Inherits="Web_biblioteca.Devolucion" %>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link "  href="Prestamos.aspx">Prestamo de Libros</a>
           ...
           <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Devolucion.aspx">Devolucion de Libros</a>
        </li>
      </ul>
    </div>
  </div>    
...
<div class="row">
  <div class="col-6 d-flex justify-content-center row mt-2">
   ...
   <div class="card-header text-center">
    Registro de Devolucion de libros
  </div>
      <div class="card-body">
        ...
        <div class="container text-center">
             ...
             <div class="col">
             <asp:Label ID="Label1" runat="server" Text="Fecha Devolucion del prestamo" CssClass="form-label"></asp:Label>
              <asp:TextBox ID="Txt_fecha" runat="server" class="form-control" Enabled="false" TextMode="Date" Width="250px" />
          </div>
             </div>
             </div>          
                </div> 
